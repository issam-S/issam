...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_kwv14fh', 'template_uwgderl', form.current, 'ZJS7n3Hxf7FBYRgg_')
      .then((result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option">
            ...
            <h4>Messrnger</h4>
            <h5>Essam Salah</h5>
            <a href="https://m.me/essam2715" target='_blank' rel="noreferrer" >Send a Message</a>
          </article>
          <article className="contact__option">
